      ...
      <>
       ...
       <hr className='h-1 bg-black rounded-lg w-[200px] mx-auto my-1'/>
          ...
          <ul className="space-y-3 mt-10 justify-center items-center">
            <li className="flex gap-2 items-center"><a href="https://maps.app.goo.gl/2HFLBVJNsKZc5NjX7" target="_blank"><FaLocationDot className="text-blue-500" /></a>Railway Colony,Rourkela,Dist-Sundergarh, Odisha, India, PIN-769013</li>
