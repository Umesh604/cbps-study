      ...
      <>
       ...
       <hr className='h-1 bg-black rounded-lg w-[200px] mx-auto my-1'/>
          ...
          <ul className="space-y-3 mt-10 justify-center items-center">
            <li className="flex gap-2 items-center"><a href="https://maps.app.goo.gl/7qgi61Y9fchmx2MF7" target="_blank"><FaLocationDot className="text-blue-500" /></a>SA-33, Shakti Nagar, Rourkela ,Dist-Sundergarh, Odisha, India, PIN-769014</li>
