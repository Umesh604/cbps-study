      ...
      <>
       ...
       <hr className='h-1 bg-black rounded-lg w-[200px] mx-auto my-1'/>
            <div className='flex flex-col md:flex-row'>
               ...
               <div>
               <iframe className="mb-5 md:w-[600px] md:h-[350px]" src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3692.587414192689!2d84.88979717529124!3d22.255727779718626!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMjLCsDE1JzIwLjYiTiA4NMKwNTMnMzIuNSJF!5e0!3m2!1sen!2sin!4v1730886728335!5m2!1sen!2sin" style={{border:0}}allowFullScreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
               </div>
          ...
          <ul className="space-y-3 mt-10 justify-center items-center">
            <li className="flex gap-2 items-center"><a href="https://maps.app.goo.gl/7qgi61Y9fchmx2MF7" target="_blank"><FaLocationDot className="text-blue-500" /></a>SA-33, Shakti Nagar, Rourkela ,Dist-Sundergarh, Odisha, India, PIN-769042</li>
            ...
            <li className="flex gap-2 items-center"><a href="https://wa.me/9439955337" target="_blank"><FaWhatsapp className="text-green-700" /></a>+91 9439955337</li>
             <li className="flex gap-2 items-center"><a href="https://wa.me/9078678382" target="_blank"><FaWhatsapp className="text-green-700" /></a>+91 9078678382</li>
